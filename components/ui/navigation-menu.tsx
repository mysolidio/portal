...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center px-4 py-2 font-medium disabled:pointer-events-none disabled:opacity-50",
);
...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        "absolute top-0 left-0 w-full p-2 pr-2.5 md:absolute md:w-auto",
        ...
        "data-[motion=to-end]:hidden data-[motion=to-start]:hidden",
        "data-[motion=from-end]:initial data-[motion=from-start]:initial",
